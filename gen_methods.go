...
func (bot *Bot)GetChatAdministratorsTgbotapi(chatId int64) ([]ChatMemberTgbotapi, error) {
	conf := ChatAdministratorsConfig{
		ChatConfig: ChatConfig{
			ChatID: chatId,
		},
	}
	resp, err := bot.RequestTgbotapi(conf)
	if err != nil {
		return []ChatMemberTgbotapi{}, err
	}

	var members []ChatMemberTgbotapi
