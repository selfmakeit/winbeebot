...
type (
	...
	DispatcherErrorHandler func(b *winbeebot.Bot, ctx *Context, err error) DispatcherAction
	// DispatcherPanicHandler allows for handling goroutine panics, where the 'r' value contains the reason for the panic.
	DispatcherPanicHandler func(b *winbeebot.Bot, ctx *Context, r interface{})
)
...
func (d *Dispatcher) processRawUpdate(b *winbeebot.Bot, r json.RawMessage) error {
	...
	//这里解析成tgbot的就用tgbot的处理方法，解析成tgbotapi的就用tgbotapi的处理方法
...
func (d *Dispatcher) ProcessUpdate(b *winbeebot.Bot, u *winbeebot.Update, data map[string]interface{}) (err error) {
...
func (d *Dispatcher) iterateOverHandlerGroups(b *winbeebot.Bot, ctx *Context) error {
