...
type PollingOpts struct {
	...
	GetUpdatesOpts *winbeebot.GetUpdatesOpts
}
...
func (u *Updater) StartPolling(b *winbeebot.Bot, opts *PollingOpts) error {
	...
	v := map[string]string{}
	var reqOpts *winbeebot.RequestOpts
	...
	if opts != nil {
		if opts.EnableWebhookDeletion || opts.DropPendingUpdates {
			...
			_, err := b.DeleteWebhook(&winbeebot.DeleteWebhookOpts{
...
func (u *Updater) SetAllBotWebhooks(domain string, opts *winbeebot.SetWebhookOpts) error {
